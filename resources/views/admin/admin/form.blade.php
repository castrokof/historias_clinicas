<div class="form-group row">
    ...
    <div class="form-group row col-md-12">
        <div class="col-md-8">
            <label for="horariodiario" class="col-xs-12 control-label requerido">Horario diario</label>
            <div class="form-group row">
    ...
    <div class="card card-cyan card-outline form-group row col-md-10 p-2" style="padding: 0px, 0px, 0px, 0px">
        ...
        <div class="form-group row p-2">
            <div class="col-md-1" id="festivos_id">
                ...
                <input type="checkbox" name="diasemanal" id="diasemanal" class="case_semana form-control select2bs4"
                    style="width: 100%;">
            </div>
            <div class="col-md-1" id="festivos_id">
                <label for="diasemanam" class="control-label tooltips" title="Lunes">M</label>
                <input type="checkbox" name="diasemanam" id="diasemanam" class="case_semana form-control select2bs4"
                    style="width: 100%;">
            </div>
            <div class="col-md-1" id="festivos_id">
                <label for="diasemanami" class="control-label">MI</label>
                <input type="checkbox" name="diasemanami" id="diasemanami"
                    class="case_semana form-control select2bs4" style="width: 100%;">
            </div>
            <div class="col-md-1" id="festivos_id">
                <label for="diasemanaj" class="control-label">J</label>
                <input type="checkbox" name="diasemanaj" id="diasemanaj" class="case_semana form-control select2bs4"
                    style="width: 100%;">
            </div>
            <div class="col-md-1" id="festivos_id">
            ...
            <div class="col-md-1" id="festivos_id">
                ...
                <input type="checkbox" name="diasemanas" id="diasemanas" class="case_semana form-control select2bs4"
                    style="width: 100%;">
            </div>
            <div class="col-md-1" id="festivos_id">
                <label for="diasemanad" class="control-label">D</label>
                <input type="checkbox" name="diasemanad" id="diasemanad" class="case_semana form-control select2bs4"
                    style="width: 100%;">
            </div>
        </div>
        <div class="col-md-6">
