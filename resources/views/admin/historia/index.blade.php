                ...
                <div class="card card-primary card-tabs">
                  <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="custom-tabs-one-datos-del-paciente-tab" data-toggle="pill" href="#custom-tabs-one-datos-del-paciente" role="tab" aria-controls="custom-tabs-one-datos-del-paciente" aria-selected="false">Datos del paciente</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-consulta-tab" data-toggle="pill" href="#custom-tabs-one-consulta" role="tab" aria-controls="custom-tabs-one-Consulta" aria-selected="false">Consulta</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-examen-tab" data-toggle="pill" href="#custom-tabs-one-examen" role="tab" aria-controls="custom-tabs-one-examen" aria-selected="false">Examen fisico</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-diagnostico-tab" 
                        data-toggle="pill" href="#custom-tabs-one-diagnostico" role="tab" 
                        aria-controls="custom-tabs-one-diagnostico" aria-selected="false">Impresión diagnóstica</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-analisisr-tab" data-toggle="pill" href="#custom-tabs-one-analisisr" role="tab" aria-controls="custom-tabs-one-analisisr" aria-selected="false">Analisis</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-terapeutico-tab" data-toggle="pill" href="#custom-tabs-one-terapeutico" role="tab" aria-controls="custom-tabs-one-terapeutico" aria-selected="false">Plan Terapeutico</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-planfarma-tab" data-toggle="pill" href="#custom-tabs-one-planfarma" role="tab" aria-controls="custom-tabs-one-planfarma" aria-selected="false">Plan Farmacologico</a>
                      </li>
                    </ul>
                  </div>
                  <div class="card-body">
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                      ...
                      <div class="tab-pane fade" id="custom-tabs-one-examen" role="tabpanel" 
                      aria-labelledby="custom-tabs-one-examen-tab">
                        <div class="card-body">
                      ...
                      <div class="tab-pane fade" id="custom-tabs-one-diagnostico" role="tabpanel" 
                      aria-labelledby="custom-tabs-one-diagnostico-tab">
                        <div class="card-body">
                      ...
                      <div class="tab-pane fade" id="custom-tabs-one-terapeutico" role="tabpanel" 
                      aria-labelledby="custom-tabs-one-terapeutico-tab">
                        <div class="card-body">
          ...
          return {
            results: $.map(data, function(data) {
              ...
              return {
                ...
                text: data.nombre_medto + "=>" + data.observacion + "=>" + data.cantidad + data.unidad_medida + "=>" + data.descripcion_medto,
                id: data.id_cums
        ...
        if (result.value) {
          $.ajax({
            ...
            success: function(data) {
              ...
              } else if (data.success == 'okdp') {
                //$('#form-general')[0].reset();
                //$('#Citas').DataTable().ajax.reload();
                //$('#modal-u').modal('hide');
                Swal.fire({
                  icon: 'warning',
                  title: 'No puedes crear un diagnostico repetido',
                  showConfirmButton: false,
                  timer: 1500
