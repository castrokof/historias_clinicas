    <div class="form-group row">
        <div class="col-lg-3">
            <label for="cod_servicio" class="col-xs-4 control-label ">Código</label>
            <input type="text" name="cod_servicio" id="cod_servicio" class="form-control" value="{{old('cod_servicio')}}" required>
        </div>
        <div class="col-lg-3">
        ...
        <div class="col-lg-3">
            <!--Este es el estado del servicio si esta activa o inactiva -->
