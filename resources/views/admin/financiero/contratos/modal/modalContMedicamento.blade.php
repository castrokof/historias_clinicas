                ...
                <div class="col-lg-12">
                    <div class="card card-warning">
                        <div class="card-header with-border">
                            <h3 class="card-title">Relación de Contratos con Medicamentos</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                <div class="tab-pane fade active show" id="custom-tabs-one-datos-del-relmedicamento" role="tabpanel" aria-labelledby="custom-tabs-one-datos-del-relmedicamento-tab">
                                    <div class="card-body">
                                        @csrf
                                        @include('admin.financiero.contratos.tablas.table-relmedicamento')
                                    </div> 
                                </div>
                            </div>
                            ...
                            <form id="form-general2" class="form-horizontal" method="POST">
                                @csrf
                                <button value ="addm"  id="addm" name="addm" type="button" class="addss btn btn-success btn-xm col-xs-2">Add+</button>
