...
@section('scriptsPlugins')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Función que envía los datos de financiero.procedimientos al controlador ademas controla los input con sweat alert2
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data.success == 'ok') {
                                        ...
                                        $('#modal-financiero.procedimientos').modal('hide');
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        $.each(result, function(i, items) {
                            $('#title-financiero.procedimientos-detalle').text(items.nombre);
                            $('#modal-financiero.procedimientos-detalle').modal({
                                backdrop: 'static',
                                keyboard: false
                            });
                            $('#modal-financiero.procedimientos-detalle').modal('show');
