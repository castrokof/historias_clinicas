    <div class="form-group row">
        <div class="col-lg-3">
            <label for="cod_barrio" class="col-xs-4 control-label ">Codigo</label>
            <input type="text" name="cod_barrio" id="cod_barrio" class="form-control" value="{{old('cod_barrio')}}" required>
        </div>
        <div class="col-lg-3">
