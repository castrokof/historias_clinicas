...
@section('contenido')
@include('admin.parametros.ocupaciones.tablas.tablaIndexOcupaciones')
@include('admin.parametros.ocupaciones.modal.modalOcupaciones')
@endsection
