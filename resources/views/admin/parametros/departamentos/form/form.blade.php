    <div class="form-group row">
        <div class="col-lg-3">
            <label for="cod_departamento" class="col-xs-4 control-label ">Codigo</label>
            <input type="text" name="cod_departamento" id="cod_departamento" class="form-control" value="{{old('cod_departamento')}}" required>
        </div>
        <div class="col-lg-3">
