    <div class="form-group row">
        <div class="col-lg-3">
            <label for="cod_ciudad" class="col-xs-4 control-label ">Codigo</label>
            <input type="text" name="cod_ciudad" id="cod_ciudad" class="form-control" value="{{old('cod_ciudad')}}" required>
        </div>
        <div class="col-lg-3">
