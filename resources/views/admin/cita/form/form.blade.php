...
<div class="form-group row mt-0 mb-0 pb-0 pt-2 pl-2 pr-2    ">
    ...
    <div class="form-group col-12 row">
        <button type="button" class="btn btn-primary btn-xs col-md-2" name="agregar_horario" id="agregar_horario"><i
            class="fa fa-plus-circle"></i> Asignar cita</button>
        <button type="button" class="btn btn-success btn-xs col-md-2" name="consultar_cita" id="consultar_cita"><i
            class="fa fa-search"></i> Consultar cita</button>
            <button type="button" class="btn btn-warning btn-xs col-md-2" name="agregar_horario" id="agregar_horario"><i
                class="fa fa-edit"></i> Editar cita</button>
            <button type="button" class="btn btn-danger btn-xs col-md-2" name="consultar_cita" id="consultar_cita"><i
                class="fa fa-trash"></i> Eliminar cita</button>
    </div>
