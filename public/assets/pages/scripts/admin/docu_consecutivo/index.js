...
$(document).ready(function () {
    ...
    //Función para abrir modal y prevenir el cierre de creación de consecutivo
    $(document).on('click', '.crear_consecutivos', function () {

        $('#modal-docu_consecutivo').modal({ backdrop: 'static', keyboard: false });
        $('#modal-docu_consecutivo').modal('show');

    });
    

    //Recuperar el valor del radio button de consecutivo
